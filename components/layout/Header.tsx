      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10 h-full flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 select-none">
            <Image src="/logo.png" alt="VeyQon Group" width={52} height={52} className="object-contain mix-blend-lighten" />
          ...
          <div className="hidden md:flex items-center">
            <a href={SCL_URL} target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-sm">
              Join Waitlist
            </a>
          </div>
